...
//   getUserProfile,
//   getHeaders,
//   updateUserLocale as apiUpdateUserLocale, //  استيراد دالة تحديث اللغة من API
// } from "../services/api";
...
//   updateUserLocale: (locale: string) => Promise<void>; //  إضافة دالة تحديث اللغة
// }
...
//   const updateUserLocale = useCallback(async (locale: string) => {
//     try {
//       const token = getToken();
//       if (!token) {
//         console.warn("No token found, cannot update locale");
//         return;
//       }

//       // تحديث اللغة في الباك اند
//       const result = await apiUpdateUserLocale(locale);
      
//       if (result.success) {
//         // تحديث اللغة في حالة المستخدم المحلية
//         setUser((prevUser) => {
//           if (prevUser) {
//             return { ...prevUser, locale };
//           }
//           return prevUser;
//         });
...
//         console.log(` Language updated to ${locale} successfully`);
//       } else {
//         console.error("Failed to update user locale:", result.message);
//       }
//     } catch (error) {
...
//       //  استعادة اللغة المحفوظة للمستخدم
...
//       }
//     },
//     [clearGuestModeAndToken, refetchCart, fetchUserData],
//   );
...
//       setIsAuthenticated(false);
//       setUser(null);
//       //  حذف اللغة المحفوظة عند تسجيل الخروج
...
//     updateUserData,
//     updateUserLocale, //  إضافة دالة تحديث اللغة
//   };
