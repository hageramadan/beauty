 ...
 // بيانات افتراضية
  ...
  const imageUrl = currentAd?.image 
    ? (currentAd.image.startsWith('http') 
        ? currentAd.image 
        : `https://beauty.admin.t-carts.com${currentAd.image}`)
          ...
          <div className="w-1/2 md:w-1/2 text-center md:text-right pt-2 md:pt-0">
            <div className="max-w-xl mx-auto md:mx-0">
              <div className="inline-block">
                <p className="text-[8px] md:text-[16px] font-semibold px-1.5 py-0.5 md:px-4 md:py-1.5 bg-black/10 text-[#E60076] rounded-full inline-block">
                  لفترة محدودة
                </p>
              </div>
